...
summary: "Here’s a quick write-up on a tiny Android application I wrote and published in two days, over the course of a weekend. Quickly find financial ratios such as Return on Capital Employed (ROCE), Return on Equity (ROE) and Return on Assets (ROA) for any company in the world."
